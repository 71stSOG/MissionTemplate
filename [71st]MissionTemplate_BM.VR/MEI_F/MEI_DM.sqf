...
for "_i" from 1 to 8 do {_this addItemToUniform "rhs_10Rnd_762x54mmR_7N1";};
...
comment "Add weapons";
_this addWeapon selectRandom ["rhs_weap_svdp","rhs_weap_svds"];
_this addPrimaryWeaponItem selectRandom ["rhs_acc_pso1m2","rhs_acc_1pn93_1"];
